...
- JoJoBear13- for his using his Trainer AI code along with Vortienes, Pokeyellow audio and GBC colors backported, Coin Observer, and a lot of QOL features from Shin-PokeRed.
