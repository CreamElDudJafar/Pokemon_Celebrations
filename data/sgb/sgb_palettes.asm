...
ENDC
	...
	RGB 31,31,31, 31,30,22, 23,27,31, 06,06,06 ; PAL_PIKACHUS_BEACH
	RGB 31,31,31, 28,23,09, 18,14,10, 06,06,06 ; PAL_PIKACHU_PORTRAIT
	RGB 31,31,31, 16,16,16, 31,25,09, 06,06,06 ; PAL_PIKACHUS_BEACH_TITLE
