...
CopycatsHouse2F_Object:
	...
	object_event  5,  1, SPRITE_JIGGLYPUFF, STAY, DOWN, TEXT_COPYCATSHOUSE2F_MONSTER
	object_event  2,  0, SPRITE_SPEAROW, STAY, LEFT, TEXT_COPYCATSHOUSE2F_BIRD
	object_event  1,  6, SPRITE_PIKACHU, STAY, RIGHT, TEXT_COPYCATSHOUSE2F_FAIRY
